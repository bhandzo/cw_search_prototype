...
export async function storeCredentials(credentials: Credentials): Promise<string> {
  const userId = uuidv4()
...
export async function getCredentialsFromToken(sessionToken: string): Promise<Credentials | null> {
